...
public class WeatherUtil {
    public static String getWeather1(String loc) throws Exception{
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=qJ2bSBwX2xaECah4wtxYq2NGCB%2FZ4KbhbWIUIT8Mym9oxwNyz0BTePdYCIup7P2QP1AXSBOygtC4Fz0iFhrcuQ%3D%3D"); /*Service Key*/
        ...
        rd.close();
        conn.disconnect();
        // 아침에 한거는 java object -> json
        // 지금 이 아래서 하는거는 json -> java object
